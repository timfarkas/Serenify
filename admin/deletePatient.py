...
docToPatient = tk.Label(root, text="Choose the patient(s) to delete:", font=("Arial", 12, "bold"))
docToPatient.pack()
...
#Button 
delete_button = tk.Button(root, text="Delete patient")  
delete_button.pack()
