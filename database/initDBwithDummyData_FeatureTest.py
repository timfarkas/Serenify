...
def initDummyDatabase(db: Database):
        ...
        forumentry2 = Forum(
            ...
            user_id=6,
            timestamp=datetime.datetime(year=2024, month=11, day=10, hour=10, minute=0, second=0)
        )
        forumentry3 = Forum(
            parent_id=1,
            ...
            user_id=4,
            timestamp=datetime.datetime(year=2024, month=11, day=22, hour=20, minute=0, second=0)
        )
        forumentry4 = Forum(
            parent_id=1,
            topic="Welcome!",
            ...
            user_id=7,
            timestamp=datetime.datetime(year=2024, month=11, day=23, hour=20, minute=0, second=0)
        )
        forumentry5 = Forum(
            parent_id=2,
            ...
            content="",
            user_id=7,
            timestamp=datetime.datetime(year=2024, month=11, day=12, hour=20, minute=0, second=0)
        )
        forumentry6 = Forum(
            parent_id=2,
            ...
            content="",
            user_id=5,
            timestamp=datetime.datetime(year=2024, month=11, day=15, hour=20, minute=0, second=0)
        )
        forumentry7 = Forum(
            parent_id=0,
            ...
            user_id=7,
            timestamp=datetime.datetime(year=2024, month=11, day=25, hour=20, minute=0, second=0)
        )
        forumentry8 = Forum(
            parent_id=7,
            ...
            content="",
            user_id=6,
            timestamp=datetime.datetime(year=2024, month=11, day=26, hour=20, minute=0, second=0)
        )
