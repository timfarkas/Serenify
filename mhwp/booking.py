...
from database.entities import Appointment, Notification
...
class MHWPAppointmentManager():
    ...
    def send_email_notification(self, notification_type, appointment_id, patient_id):
        ...
        try:
            ...
            if notification_type == 'accept':
                ...
                messagetosent = "AppointmentConfirmed"
    ...
    def back_to_dashboard(self):
        ...
        # sys.path.append(os.path.dirname(os.path.abspath("mhwp")))
        # self.db.close()
